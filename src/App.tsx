...
function App() {
    return (
        <div className="App">
            <Header>
                <Navigation/>
                <LoginBtn accessKey={'x'} aria-label={"login"}>LOGIN</LoginBtn>
            </Header>
            <Block>
                <Title>Accessibility</Title>
                <Form>
                    <div>
                        {/*aria-hidden - не читать элемент*/}
                        <Label aria-hidden htmlFor="1">Label for field 1</Label>
                        {/*плейсхолдеры скринридер видит*/}
                        <Field tabIndex={1} id="1" placeholder="Hello my friend"/>
                    </div>
                    ...
                    <div>
                        ...
                        <Field tabIndex={2} id="3" placeholder="Field 3"/>
                    </div>
                </Form>
            </Block>
        </div>
